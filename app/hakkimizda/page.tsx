                                ...
                                <div className="prt-page-title-row-heading">
                                    <div className="about-page-title">
                                        <div className="page-title-heading" data-aos="fade-up" data-aos-duration="1400">
                                            <h2 className="title">Kaliteyi Öncelik Edinen <br/>Güvenilir Çözüm Ortağınız
                                            </h2>
                                        </div>
                                    </div>
                                    <div className="page-title-desc" data-aos="fade-up" data-aos-duration="1400">
                                        ...
                                        <div className="section-title-img" >
                                            ...
                                            <a href="tel:+902124654099" style={{ color: "#000"}}>+90 (212) 465 40 99</a>
                                        </div>
                                    </div>
                            ...
                            <div className="featured-icon-box icon-align-top-content style4 box-1" data-aos="fade-up"
                                ...
                                <div className="featured-detail">
                                    <div className="featured-desc">
                                        <h4>Mutlu Müşteri</h4>
                                        <p>Global tekstil markalarına kalite kontrol ve tedarik çözümleri sunarak,
                                            müşteri memnuniyetinde fark yaratıyoruz.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="featured-icon-box icon-align-top-content style4 box-2" data-aos="fade-up"
                                ...
                                <div className="featured-detail">
                                    <div className="featured-desc">
                                        ...
                                        <p>Yüksek standartlara uygun kumaş denetimleri ve sürdürülebilir üretim
                                            süreçleriyle sektöre liderlik ediyoruz.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="featured-icon-box icon-align-top-content style4 box-3" data-aos="fade-up"
                                ...
                                <div className="featured-detail">
                                    <div className="featured-desc">
                                        ...
                                        <p>Tecrübeli ekibimizle her projeye tam bağlılık göstererek müşteri odaklı
                                    ...
                                    <div className="col-lg-6">
                                        <div className="pattern-img bg-base-dark pt-30">
                                            <div className="layer-content">
                                                <Slider {...(sliderSettings as unknown as any)}
                                                        className="vertical_slider testimonial">
                                                    <div className="featured-content-wrapper featured-content">
                                                        ...
                                                        <div>
                                                            <p style={{color: "#000"}}>
                                                                Üretim süreçlerinizi iyileştirmek ve en son
                                                                teknolojileri uygulamak için uzman çözümler sunuyoruz.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="featured-content-wrapper featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p style={{color: "#000"}}>
                                                                Proje süreçlerinizi planlama, uygulama ve kontrol etme
                                                                aşamalarında profesyonel destek sağlıyoruz.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="featured-content-wrapper featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p style={{color: "#000"}}>
                                                                Tedarik zincirinizi optimize etmek, maliyetleri düşürmek
                                                                ve süreçleri hızlandırmak için kapsamlı çözümler
                                                                sunuyoruz.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="featured-content-wrapper featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p style={{color: "#000"}}>
                                                                Çevresel etkilerinizi azaltacak, sürdürülebilir üretim
                                                                ve tedarik süreçleri için stratejik rehberlik
                                                                sağlıyoruz.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="featured-content-wrapper featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p style={{color: "#000"}}>
                                                                Üretimden teslimata kadar tüm aşamalarda kalite
                                                                standartlarını sağlamak için profesyonel denetim
